...
/**
 * Cancel or Refund a Payment (HTTP Post)
 * 
 ...
 * 
 * @link /4.Modifications/HttpPost/CancelOrRefundPayment
 * @author Created by Adyen - Payments Made Easy
 */

@WebServlet("/4.Modifications/HttpPost/CancelOrRefundPayment")
public class CancelOrRefundPaymentHttpPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Collections.addAll(postParameters,
			new BasicNameValuePair("action", "Payment.cancelOrRefund"),
