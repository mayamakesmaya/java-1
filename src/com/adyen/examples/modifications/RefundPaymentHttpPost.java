 ...
 * 
 * @link /4.Modifications/HttpPost/RefundPayment
 * @author Created by Adyen - Payments Made Easy
 */

@WebServlet("/4.Modifications/HttpPost/RefundPayment")
public class RefundPaymentHttpPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Collections.addAll(postParameters,
			new BasicNameValuePair("action", "Payment.refund"),
