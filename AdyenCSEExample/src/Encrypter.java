...
public class Encrypter {
	...
	public String encrypt(String plainText) throws EncrypterException {
		...
		try {
			...
			Base64.encodeBase64(encryptedAESKey);
			return PREFIX + VERSION + SEPARATOR + new String( Base64.encodeBase64(encryptedAESKey) ) + SEPARATOR + new String( Base64.encodeBase64(result) );
		} catch (IllegalBlockSizeException e) {
